...
<body>
    <?php 
        $oid=$_GET['oid'];
        $oid = urldecode($oid);
        $query="select * from new_billing where oid='$oid'";
        // echo $query;
        ...
        <div class="tm_invoice_in">
          ...
          <div class="tm_invoice_info">
            ...
            <div class="tm_invoice_info_list tm_white_color">
              <p class="tm_invoice_number tm_m0">Estimate No: <b><?php echo $oid ?></b></p>
          ...
          <div class="tm_invoice_head tm_mb10">
              <div class="tm_invoice_right tm_text_left">
                ...
                <div class="tm_text_right">
                  <p class="tm_mb2"><b class="tm_primary_color">Estimate To:</b></p>
                  <p>
                ...
                <table>
                  ...
                  <tbody>
                    ...
                    <tr class="fs-12">
                      ...
                      <td class="tm_width_2"><?php echo '₹'.number_format($product['mrp_price'],2); ?></td>
                      <td class="tm_width_1"><?php echo $product['qty'] ?></td>
                      <td class="tm_width_2 tm_text_right"><?php echo '₹'.number_format($product['mrp_total'],2); ?></td>
                    </tr>
                    <?php $sno++; } ?>
                  </tbody>
                </table>
