...
<?php include 'core/Staffs/getorders.php' ?>
<!-- Begin page -->
            ...
            <div class="container-fluid">
                <div class="row">
                        <div class="col-12">
                            ...
                            <div class="card-body">
                                    <div id="response"></div>
                                    <h4 class="card-title">Staff Orders</h4>
                                    ...
                                    <div style="width:100%;overflow-x:scroll">
                                        <table id="orderTable" class="table table-striped table-bordered dt-responsive nowrap" 
                                            ...
                                            <tbody>
                                                <?php echo getOrders('new_billing',$_GET['user'])?>
                                            </tbody>
                                        </table>
                                    </div>
...
<script>
    ...
    $('#arderTable').DataTable({
        'processing': true,
        'serverSide': true,
        'serverMethod': 'post',
        'ajax': {
            'url': 'core/Staffs/ajax-getorders.php',
        },
        'columns': [
            { data: 'Sno' },
            { data: 'OrderId' },
